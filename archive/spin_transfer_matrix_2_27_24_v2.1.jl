...
# ╔═╡ ba260290-d0d0-11ee-39e5-f99673b10cb7
begin 
	using ITensors
	ITensors.compile
	using Plots 
...
# ╔═╡ 17cef487-74c2-4cea-8689-126be454c304
html"""
	<style>
	main {
		margin: 0 auto;
    	...
    	padding-right: max(80px, 10%);
		}
	</style>
	"""

# ╔═╡ 7243b340-38f4-437f-a579-aa2c231dd469


# ╔═╡ 43a157ce-9b20-451e-9b3c-6168cb9a32e1
square(5)

# ╔═╡ 0e4bdb05-aa62-45d1-ab2f-4425678a2ba3
md"""Our goal is to mechanistically contract eq 457 and understand how it works from the perspective of an eigenbasis/spectral transformation"""

# ╔═╡ e4a6ce36-d9d5-45d2-a3c7-3b78c665dff8
begin

N=4    # we define global lattice data structure such that MPOs share indicies
lat = siteinds("S=1/2", N); # assign N ℂ^2 vector spaces 
...
# ╔═╡ d6638200-bd63-497e-a943-b7868adb507c
begin
	ops = Array{Any}(nothing, 2^N)
	sm = [(0,0),(1,0),(1,1),(1,-1)]
	for n = 1:2^N
		i = div(n-1,N) + 1
		r = rem(n-1,N) + 1
		ops[n] = Π(i,sm[r][1],sm[r][2])
		print(i,'\t',r,'\t',sm[r],'\n')
	end
end


# ╔═╡ eedfb232-4b24-49c0-be77-67fb89dbb1f9
begin
	println(tr(apply(ops[3], ops[8];)))
	for i=1:4
		for j=i:4
			println(tr(apply(ops[i], ops[j];)))
		end
	end
end

# ╔═╡ 2af5f975-11a6-405e-bd65-4f099635e579
begin
...
# ╔═╡ 675feffa-23fa-4e2a-991d-2ce2d8a6a282
begin
	# Define a function to calculate the square of a number
	function square(x)
	    return x^2
...
manifest_format = "2.0"
project_hash = "856cf3dbc752e84f295734ac05db8af494a3ac3c"
...
git-tree-sha1 = "0bd6929c9773e78e55fd57b019528d909e034374"
...
git-tree-sha1 = "ea55bdf2fcdbf558d7926db52966c2361e969edd"
...
git-tree-sha1 = "c9cd7d83648a49ac106e9e351ff9580fee763f2c"
